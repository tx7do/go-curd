...
func TestFilter(t *testing.T) {
	...
	t.Run("MySQL_FilterEqual", func(t *testing.T) {
		...
		p = processor.Equal(s, p, "name", "tom")
		s.Where(p)
	...
	t.Run("MySQL_FilterNot", func(t *testing.T) {
		...
		p = processor.NotEqual(s, p, "name", "tom")
		s.Where(p)
	...
	t.Run("MySQL_FilterGTE", func(t *testing.T) {
		...
		p = processor.GTE(s, p, "create_time", "2023-10-25")
		s.Where(p)
	...
	t.Run("MySQL_FilterGT", func(t *testing.T) {
		...
		p = processor.GT(s, p, "create_time", "2023-10-25")
		s.Where(p)
	...
	t.Run("MySQL_FilterLTE", func(t *testing.T) {
		...
		p = processor.LTE(s, p, "create_time", "2023-10-25")
		s.Where(p)
	...
	t.Run("MySQL_FilterLT", func(t *testing.T) {
		...
		p = processor.LT(s, p, "create_time", "2023-10-25")
		s.Where(p)
	...
	t.Run("MySQL_FilterIsNull", func(t *testing.T) {
		...
		p = processor.IsNull(s, p, "name", "true")
		s.Where(p)
	...
	t.Run("MySQL_FilterIsNotNull", func(t *testing.T) {
		...
		p = processor.IsNotNull(s, p, "name", "true")
		s.Where(p)
	...
	t.Run("MySQL_FilterContains", func(t *testing.T) {
		...
		p = processor.Contains(s, p, "name", "L")
		s.Where(p)
	...
	t.Run("MySQL_FilterInsensitiveContains", func(t *testing.T) {
		...
		p = processor.InsensitiveContains(s, p, "name", "L")
		s.Where(p)
	...
	t.Run("MySQL_FilterStartsWith", func(t *testing.T) {
		...
		p = processor.StartsWith(s, p, "name", "La")
		s.Where(p)
	...
	t.Run("MySQL_FilterInsensitiveStartsWith", func(t *testing.T) {
		...
		p = processor.InsensitiveStartsWith(s, p, "name", "La")
		s.Where(p)
	...
	t.Run("MySQL_FilterEndsWith", func(t *testing.T) {
		...
		p = processor.EndsWith(s, p, "name", "La")
		s.Where(p)
	...
	t.Run("MySQL_FilterInsensitiveEndsWith", func(t *testing.T) {
		...
		p = processor.InsensitiveEndsWith(s, p, "name", "La")
		s.Where(p)
	...
	t.Run("MySQL_FilterInsensitiveExact", func(t *testing.T) {
		...
		p = processor.InsensitiveExact(s, p, "name", "La")
		s.Where(p)
	...
	t.Run("MySQL_FilterRegex", func(t *testing.T) {
		...
		p = processor.Regex(s, p, "name", "^(An?|The) +")
		s.Where(p)
	...
	t.Run("MySQL_FilterInsensitiveRegex", func(t *testing.T) {
		...
		p = processor.InsensitiveRegex(s, p, "name", "^(An?|The) +")
		s.Where(p)
	...
	t.Run("MySQL_FilterDatePart", func(t *testing.T) {
		...
		p = processor.DatePart(s, p, "date", "pub_date")
		p.EQ("", "2023-01-01")
		s.Where(p)
	...
	t.Run("MySQL_FilterJsonb", func(t *testing.T) {
		...
		p = processor.Jsonb(s, p, "daily_email", "preferences")
		p.EQ("", "true")
		s.Where(p)
...
func TestFilterJsonbField(t *testing.T) {
	...
	t.Run("Postgres_JsonbField", func(t *testing.T) {
		s := sql.Dialect(dialect.Postgres).Select("*").From(sql.Table("app_profile"))
		str := processor.JsonbField(s, "daily_email", "preferences")
		fmt.Println(str)
	...
	t.Run("MySQL_JsonbField_Equal", func(t *testing.T) {
		s := sql.Dialect(dialect.MySQL).Select("*").From(sql.Table("menus"))

		p := sql.P()

		p = sf.MakeFieldFilter(s, []string{"meta.title"}, "tom")
		s.Where(p)
	...
	t.Run("PostgreSQL_JsonbField_Equal", func(t *testing.T) {
	...
	t.Run("MySQL_JsonbField_Not", func(t *testing.T) {
		s := sql.Dialect(dialect.MySQL).Select("*").From(sql.Table("users"))

		p := sql.P()

		p = sf.MakeFieldFilter(s, []string{"meta.title", "not"}, "tom")
		s.Where(p)
	...
	t.Run("PostgreSQL_JsonbField_Not", func(t *testing.T) {
		s := sql.Dialect(dialect.Postgres).Select("*").From(sql.Table("users"))
	...
	t.Run("MySQL_JsonbField_Not_Date", func(t *testing.T) {
		s := sql.Dialect(dialect.MySQL).Select("*").From(sql.Table("users"))

		p := sql.P()

		p = sf.MakeFieldFilter(s, []string{"meta.title", "date", "not"}, "2023-01-01")
		s.Where(p)
	...
	t.Run("PostgreSQL_JsonbField_Not_Date", func(t *testing.T) {
		s := sql.Dialect(dialect.Postgres).Select("*").From(sql.Table("users"))
